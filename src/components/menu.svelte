...
<nav class="navbar rounded-boxx shadow-base-300/20 shadow-smx border-bx border-gray-100">
  <div class="w-full md:flex md:items-center md:gap-2">
    <div class="flex items-center justify-between">
      <div class="navbar-start items-center justify-between max-md:w-full">
        <a class="link text-base-content link-neutral text-xl font-bold no-underline" href="/">Equineist.com</a>
        <div class="md:hidden">
